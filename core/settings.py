...
if os.environ.get('DB_ENGINE') == 'postgresql':
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('DB_NAME', 'join_db'),
            'USER': os.environ.get('DB_USER', 'join_user'),
            'PASSWORD': os.environ.get('DB_PASSWORD', 'join_password'),
...
AUTH_USER_MODEL = 'auth_app.CustomUserProfile'
